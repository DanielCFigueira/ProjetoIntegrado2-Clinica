...
<div class="card">
   ...
   <form method="GET" action="<?= BASE_URL ?>relatorios/paciente" class="card" style="margin-top: 1rem;">
                    ...
                    <div class="card" style="margin-top: 1rem; border-left: 5px solid var(--primary-color);">
                        ...
                        <?php foreach($procedimentos_todos as $proc): ?>
                            <div class="sub-card">
                               ...
                               <p><strong>Profissional:</strong> <?= htmlspecialchars($proc['dentista_nome'] ?? 'Não informado') ?></p>
...
<div id="modalUpload" class="modal">
    <div class="modal-content">
        ...
        <form id="form-upload-arquivo" action="<?= BASE_URL ?>action="<?= BASE_URL ?>procedimentos/salvarArquivo" method="POST" enctype="multipart/form-data">
                ...
                procedimentos.forEach(proc => {
                    ...
                    const procHtml = `
                        <div class="sub-card">
                            ...
                            <p><strong>Profissional:</strong> ${proc.dentista_nome || 'Não informado'}</p>
        ...
        document.body.addEventListener('click', function(event) {
            ...
            if (event.target.classList.contains('btn-remover-anexo')) {
                ...
                showConfirm('Remover Anexo', 'Você realmente deseja apagar esse arquivo?', function() {
                    fetch('<?= BASE_URL ?>procedimentos/removerDeAtendimentoAjax', {
                        method: 'POST',
                        headers: {
