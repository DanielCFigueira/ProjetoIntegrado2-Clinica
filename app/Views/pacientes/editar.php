...
<div class="card">
    ...
    <form action="<?= BASE_URL ?>pacientes/atualizar" method="POST">
        ...
        <div style="display: flex; gap: 1rem;">
            ...
            <a href="<?= BASE_URL ?>pacientes.php" class="btn btn-cancel">Cancelar</a>
        </div>
    </form>
</div>
...
function validarEmail(field) {
    ...
    if (field.value === '') { errorSpan.style.display = 'none'; return; }
