...
<?php
// O controller deve providenciar a variável $usuarios.
// Este arquivo é a view; não deve executar consultas diretas ao banco.
// As checagens de sessão e controle de acesso são feitas no controller.
?>
                    ...
                    <tr>
                        ...
                        <td data-label= "Ações" style="display: flex; gap: 0.5rem;">
                            ...
                            <?php if ($usuario['id'] !== $_SESSION['usuario_id']): // Não pode excluir a si mesmo ?>
                                <a href="<?= BASE_URL ?>usuarios/excluir?id=<?= $usuario['id'] ?>" class="btn btn-danger btn-delete">Remover</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
